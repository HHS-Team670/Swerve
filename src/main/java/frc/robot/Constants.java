...
public final class Constants {
    ...
    public static final int FRONT_LEFT_MODULE_STEER_MOTOR = 20; // FIXME Set front left module steer motor ID
    public static final int FRONT_LEFT_MODULE_STEER_ENCODER = 30; // FIXME Set front left steer encoder ID
    ...
    public static final int FRONT_RIGHT_MODULE_DRIVE_MOTOR = 23; // FIXME Set front right drive motor ID
    ...
    public static final int BACK_LEFT_MODULE_DRIVE_MOTOR = 27; // FIXME Set back left drive motor ID
    public static final int BACK_LEFT_MODULE_STEER_MOTOR = 26; // FIXME Set back left steer motor ID
    public static final int BACK_LEFT_MODULE_STEER_ENCODER = 36; // FIXME Set back left steer encoder ID
    public static final double BACK_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(0.0); // FIXME Measure and set back left steer offset

    public static final int BACK_RIGHT_MODULE_DRIVE_MOTOR = 25; // FIXME Set back right drive motor ID
